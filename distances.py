...
def main():
    pred=cv2.imread(r"D:\ai intro\Angiografii\PROIECT_ANGIOGRAFII\PREDICTIE_14_3.png")
    gt=cv2.imread(r"D:\ai intro\Angiografii\PROIECT_ANGIOGRAFII\Experiment_Dice_index11282022_1227\Test12112022_1345\PREDICTIE_4_0.png")

...
import glob
from monai.losses import DiceCELoss , DiceLoss , DiceFocalLoss , FocalLoss , TverskyLoss
...
def main():
    ...
    pixel_t = TR.Compose([
        ...
        #TR.HistogramNormalized(keys="img",num_bins=config['train']['histogram_ctrlpts']),
